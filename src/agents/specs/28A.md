...
# Subagent 28A — International Source Auditor
...
Verify factual claims, source independence, dates and disputed evidence.

Answer these research questions:

1. Is every international claim traceable to a dated primary source?
2. Are apparently corroborating sources actually independent?
...
Write `research/findings/28/28A-<task>.json` with the common fields
...
Full JSON schema: `config/subagents.json` → `28A.output_schema`.
...
- All required specific fields are present: source_findings, verdict.

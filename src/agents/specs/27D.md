...
# Subagent 27D — Multilateral Cooperation Researcher
...
Simulate economic diplomacy and international crisis-coordination scenarios using documented institutional procedures.

Answer these research questions:

1. What documented procedures govern crisis financing and coordination?

## Evidence requirements

**Data required:**
- institutional procedure documents
...
Write `research/findings/27/27D-<task>.json` with the common fields
...
Full JSON schema: `config/subagents.json` → `27D.output_schema`.
...
- All required specific fields are present: procedure_maps.

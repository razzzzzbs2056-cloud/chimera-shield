...
| Date | What |
|------|------|
| **Sep 29** | Name/trademark check, buy main + cold-email domains, set up email with SPF/DKIM/DMARC |
| **Oct 5** | Start cold-email warm-up |
| **Oct 8** | Legal-ops checks the facts on irs.gov / ftc.gov / eCFR before anything is published |
| **~Oct 15** | Readiness Check live; PTIN renewal opens |
| Oct 30 / Nov 20 | Channel review checkpoints (keep or stop) |
| Nov 2 | YC W27 deadline (optional, low odds) |
